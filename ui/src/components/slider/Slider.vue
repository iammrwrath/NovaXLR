...
export default {
  ...
  props: {
    ...
    backgroundColour: {type: String, required: false, default: "#161b28"},
    inputBackgroundColour: {type: String, required: false, default: "#1e2434"},
    rangeBackgroundColour: {type: String, required: false, default: '#0c0f16'},
    rangeColour: { type: String, required: false, default: '#0ea5e9' },
    textColour: {type: String, required: false, default: '#38bdf8' },
    labelColour: {type: String, required: false, default: '#f8fafc'},
